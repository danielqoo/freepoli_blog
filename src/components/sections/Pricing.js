...
const priceboxData = [
  {
    ...
    content: [
      {
        id: 0,
        text: "부정적인 감정을 글로써 표현하고 해소하며 성숙한 통찰과 내면의 힘을 확립합니다.",
      },
      // {
      //   id: 1,
  ...
  },
  {
    ...
    content: [
      {
        id: 0,
        text: "건강한 애도를 통해 새로 살아갈 힘을 얻고, 내일을 위한 성장의 기반을 마련합니다.",
      },
      // {
      //   id: 1,
  ...
  },
  {
    id: 3,
    title: "소셜벤처로의 성장",
    icon: "images/seedling.svg",
    content: [
      { 
        id: 0, 
        text: "자유롭고 편안한 애도 문화를 통해 지역공동체 회복을 돕고 사회 통합에 기여합니다." 
      },
      // { 
      //   id: 1, 
